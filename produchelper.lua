...
local lmPath = "produchelper.lua"
local lmUrl = "https://raw.githubusercontent.com/justskitpy/image/main/produchelper.lua"
...
imgui.OnFrame(function() return menu[0] end,
    ...
    if imgui.Button(u8'Проверить на наличие обновления', imgui.ImVec2(-1, 50)) then
	check_update()
	end
